   ...
   <>
      ...
      <div className="container footer-bottom ">
        ...
        <p className="mb-0 text-center text-muted-white">
          © 2024 <span className="ms-1">Shafeena Electricals. All rights reserved.</span>
        </p>
        <p className="mb-0 text-center">
          <span className='text-muted-white'>Designed & Developed By</span> <Link to="https://www.navakarana.com"  className='text-decoration-underline text-light fw-medium'>NAVAKARANA TECHNOLOGIES</Link>
        </p>
        </div>
      </div>
